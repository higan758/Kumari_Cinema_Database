<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="WebForm.SimpleWebform.User" %>
<!DOCTYPE html>
        ...
        <div class="container">
            ...
            <div class="content-row">
                <div class="card">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="USERID" DataSourceID="SqlDataSource1" GridLines="None" CssClass="styled-grid">
                        <Columns>
                ...
                <div class="card-side">
                    <asp:FormView ID="FormView1" runat="server" DataKeyNames="USERID" DataSourceID="SqlDataSource1" DefaultMode="ReadOnly" RenderOuterTable="false">
                        <EditItemTemplate>
                            <div class="form-title">Edit User</div>
                            <table>
                                <tr><td class="field-label">USERID:</td><td><asp:Label ID="USERIDLabel1" runat="server" Text='<%# Eval("USERID") %>' /></td></tr>
                                <tr><td class="field-label">NAME:</td><td><asp:TextBox ID="NAMETextBox" runat="server" Text='<%# Bind("NAME") %>' /></td></tr>
                                <tr><td class="field-label">EMAIL:</td><td><asp:TextBox ID="EMAILTextBox" runat="server" Text='<%# Bind("EMAIL") %>' /></td></tr>
                                <tr><td class="field-label">Phone Number:</td><td><asp:TextBox ID="Phone_NumberTextBox" runat="server" Text='<%# Bind("Phone_Number") %>' /></td></tr>
                            </table>
                        ...
                        <InsertItemTemplate>
                            ...
                            <table>
                                <tr><td class="field-label">USERID:</td><td><asp:TextBox ID="USERIDTextBox" runat="server" Text='<%# Bind("USERID") %>' /></td></tr>
                                <tr><td class="field-label">NAME:</td><td><asp:TextBox ID="NAMETextBox" runat="server" Text='<%# Bind("NAME") %>' /></td></tr>
                                <tr><td class="field-label">EMAIL:</td><td><asp:TextBox ID="EMAILTextBox" runat="server" Text='<%# Bind("EMAIL") %>' /></td></tr>
                                <tr><td class="field-label">Phone Number:</td><td><asp:TextBox ID="Phone_NumberTextBox" runat="server" Text='<%# Bind("Phone_Number") %>' /></td></tr>
                            </table>
                        ...
                        <ItemTemplate>
                            <div class="form-title">Selected User</div>
                            <table>
                                <tr><td class="field-label">USERID:</td><td><asp:Label ID="USERIDLabel" runat="server" Text='<%# Eval("USERID") %>' /></td></tr>
                                <tr><td class="field-label">NAME:</td><td><asp:Label ID="NAMELabel" runat="server" Text='<%# Eval("NAME") %>' /></td></tr>
                                <tr><td class="field-label">EMAIL:</td><td><asp:Label ID="EMAILLabel" runat="server" Text='<%# Eval("EMAIL") %>' /></td></tr>
                                <tr><td class="field-label">Phone Number:</td><td><asp:Label ID="Phone_NumberLabel" runat="server" Text='<%# Eval("Phone_Number") %>' /></td></tr>
                            </table>
                            <div style="margin-top:16px;">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>"
                SelectCommand="SELECT &quot;USERID&quot;, &quot;NAME&quot;, &quot;EMAIL&quot;, &quot;Phone Number&quot; AS &quot;Phone_Number&quot; FROM &quot;User&quot; ORDER BY &quot;USERID&quot; ASC"
                DeleteCommand="DELETE FROM &quot;User&quot; WHERE &quot;USERID&quot; = :USERID"
                InsertCommand="INSERT INTO &quot;User&quot; (&quot;USERID&quot;, &quot;NAME&quot;, &quot;EMAIL&quot;, &quot;Phone Number&quot;) VALUES (:USERID, :NAME, :EMAIL, :Phone_Number)"
                UpdateCommand="UPDATE &quot;User&quot; SET &quot;NAME&quot; = :NAME, &quot;EMAIL&quot; = :EMAIL, &quot;Phone Number&quot; = :Phone_Number WHERE &quot;USERID&quot; = :USERID">
                <DeleteParameters>

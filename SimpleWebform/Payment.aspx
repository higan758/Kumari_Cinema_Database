<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="WebForm.SimpleWebform.Payment" %>
<!DOCTYPE html>
        ...
        <div class="container">
            ...
            <div class="content-row">
                <div class="card">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="PAYMENTID" DataSourceID="SqlDataSource1" GridLines="None" CssClass="styled-grid">
                        <Columns>
                ...
                <div class="card-side">
                    <asp:FormView ID="FormView1" runat="server" DataKeyNames="PAYMENTID" DataSourceID="SqlDataSource1" DefaultMode="ReadOnly" RenderOuterTable="false">
                        <EditItemTemplate>
                            <div class="form-title">Edit Payment</div>
                            <table>
                                <tr><td class="field-label">Payment ID:</td><td><asp:Label ID="PAYMENTIDLabel1" runat="server" Text='<%# Eval("PAYMENTID") %>' /></td></tr>
                                <tr><td class="field-label">Date:</td><td><asp:TextBox ID="PAYMENTDATETextBox" runat="server" Text='<%# Bind("PAYMENTDATE") %>' /></td></tr>
                                <tr><td class="field-label">Method:</td><td><asp:TextBox ID="PAYMENTMETHODTextBox" runat="server" Text='<%# Bind("PAYMENTMETHOD") %>' /></td></tr>
                                <tr><td class="field-label">Status:</td><td><asp:TextBox ID="PAYMENTSTATUSTextBox" runat="server" Text='<%# Bind("PAYMENTSTATUS") %>' /></td></tr>
                                <tr><td class="field-label">Amount:</td><td><asp:TextBox ID="PAYMENTAMOUNTTextBox" runat="server" Text='<%# Bind("PAYMENTAMOUNT") %>' /></td></tr>
                        ...
                        <InsertItemTemplate>
                            ...
                            <table>
                                <tr><td class="field-label">Payment ID:</td><td><asp:TextBox ID="PAYMENTIDTextBox" runat="server" Text='<%# Bind("PAYMENTID") %>' /></td></tr>
                                <tr><td class="field-label">Date:</td><td><asp:TextBox ID="PAYMENTDATETextBox" runat="server" Text='<%# Bind("PAYMENTDATE") %>' /></td></tr>
                                <tr><td class="field-label">Method:</td><td><asp:TextBox ID="PAYMENTMETHODTextBox" runat="server" Text='<%# Bind("PAYMENTMETHOD") %>' /></td></tr>
                                <tr><td class="field-label">Status:</td><td><asp:TextBox ID="PAYMENTSTATUSTextBox" runat="server" Text='<%# Bind("PAYMENTSTATUS") %>' /></td></tr>
                                <tr><td class="field-label">Amount:</td><td><asp:TextBox ID="PAYMENTAMOUNTTextBox" runat="server" Text='<%# Bind("PAYMENTAMOUNT") %>' /></td></tr>
                        ...
                        <ItemTemplate>
                            <div class="form-title">Selected Payment</div>
                            <table>
                                <tr><td class="field-label">Payment ID:</td><td><asp:Label ID="PAYMENTIDLabel" runat="server" Text='<%# Eval("PAYMENTID") %>' /></td></tr>
                                <tr><td class="field-label">Date:</td><td><asp:Label ID="PAYMENTDATELabel" runat="server" Text='<%# Eval("PAYMENTDATE") %>' /></td></tr>
                                <tr><td class="field-label">Method:</td><td><asp:Label ID="PAYMENTMETHODLabel" runat="server" Text='<%# Eval("PAYMENTMETHOD") %>' /></td></tr>
                                <tr><td class="field-label">Status:</td><td><asp:Label ID="PAYMENTSTATUSLabel" runat="server" Text='<%# Eval("PAYMENTSTATUS") %>' /></td></tr>
                                <tr><td class="field-label">Amount:</td><td><asp:Label ID="PAYMENTAMOUNTLabel" runat="server" Text='<%# Eval("PAYMENTAMOUNT") %>' /></td></tr>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>"
                SelectCommand="SELECT * FROM &quot;PAYMENT&quot; ORDER BY &quot;PAYMENTID&quot; ASC"
                DeleteCommand="DELETE FROM &quot;PAYMENT&quot; WHERE &quot;PAYMENTID&quot; = :PAYMENTID"
                InsertCommand="INSERT INTO &quot;PAYMENT&quot; (&quot;PAYMENTID&quot;, &quot;PAYMENTDATE&quot;, &quot;PAYMENTMETHOD&quot;, &quot;PAYMENTSTATUS&quot;, &quot;PAYMENTAMOUNT&quot;, &quot;BOOKING_BOOKINGID&quot;) VALUES (:PAYMENTID, :PAYMENTDATE, :PAYMENTMETHOD, :PAYMENTSTATUS, :PAYMENTAMOUNT, :BOOKING_BOOKINGID)"
                UpdateCommand="UPDATE &quot;PAYMENT&quot; SET &quot;PAYMENTDATE&quot; = :PAYMENTDATE, &quot;PAYMENTMETHOD&quot; = :PAYMENTMETHOD, &quot;PAYMENTSTATUS&quot; = :PAYMENTSTATUS, &quot;PAYMENTAMOUNT&quot; = :PAYMENTAMOUNT, &quot;BOOKING_BOOKINGID&quot; = :BOOKING_BOOKINGID WHERE &quot;PAYMENTID&quot; = :PAYMENTID">
                <DeleteParameters><asp:Parameter Name="PAYMENTID" Type="Decimal" /></DeleteParameters>
                <InsertParameters>

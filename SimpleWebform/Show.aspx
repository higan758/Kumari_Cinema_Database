<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="WebForm.SimpleWebform.Show" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="content-row">
                <div class="card">
                    <div class="page-title">Show Management</div>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="SHOWID" DataSourceID="SqlDataSource1" GridLines="None" CssClass="styled-grid">
                        <Columns>
                            ...
                            <asp:BoundField DataField="MOVIE_MOVIEID" HeaderText="Movie ID" SortExpression="MOVIE_MOVIEID" />
                            <asp:BoundField DataField="BASETICKETPRICE" HeaderText="Base Price" SortExpression="BASETICKETPRICE" />
                        </Columns>
                        <AlternatingRowStyle CssClass="row-alt" />
                    </asp:GridView>
                </div>
                <div class="card-side">
                    <asp:FormView ID="FormView1" runat="server" DataKeyNames="SHOWID" DataSourceID="SqlDataSource1" DefaultMode="ReadOnly" RenderOuterTable="false">
                        <EditItemTemplate>
                            <div class="form-title">Edit Show</div>
                            <table>
                                <tr><td class="field-label">Show ID:</td><td><asp:Label ID="SHOWIDLabel1" runat="server" Text='<%# Eval("SHOWID") %>' /></td></tr>
                                <tr><td class="field-label">Show Date:</td><td><asp:TextBox ID="SHOWDATETextBox" runat="server" Text='<%# Bind("SHOWDATE") %>' /></td></tr>
                                <tr><td class="field-label">Show Time:</td><td><asp:TextBox ID="SHOWTIMETextBox" runat="server" Text='<%# Bind("SHOWTIME") %>' /></td></tr>
                                <tr><td class="field-label">Hall ID:</td><td><asp:TextBox ID="HALL_HALLIDTextBox" runat="server" Text='<%# Bind("HALL_HALLID") %>' /></td></tr>
                                <tr><td class="field-label">Movie ID:</td><td><asp:TextBox ID="MOVIE_MOVIEIDTextBox" runat="server" Text='<%# Bind("MOVIE_MOVIEID") %>' /></td></tr>
                                <tr><td class="field-label">Base Price:</td><td><asp:TextBox ID="BASETICKETPRICETextBox" runat="server" Text='<%# Bind("BASETICKETPRICE") %>' /></td></tr>
                            </table>
                        ...
                        <InsertItemTemplate>
                            <div class="form-title">Add New Show</div>
                            <table>
                                <tr><td class="field-label">Show ID:</td><td><asp:TextBox ID="SHOWIDTextBox" runat="server" Text='<%# Bind("SHOWID") %>' /></td></tr>
                                <tr><td class="field-label">Show Date:</td><td><asp:TextBox ID="SHOWDATETextBox" runat="server" Text='<%# Bind("SHOWDATE") %>' /></td></tr>
                                <tr><td class="field-label">Show Time:</td><td><asp:TextBox ID="SHOWTIMETextBox" runat="server" Text='<%# Bind("SHOWTIME") %>' /></td></tr>
                                <tr><td class="field-label">Hall ID:</td><td><asp:TextBox ID="HALL_HALLIDTextBox" runat="server" Text='<%# Bind("HALL_HALLID") %>' /></td></tr>
                                <tr><td class="field-label">Movie ID:</td><td><asp:TextBox ID="MOVIE_MOVIEIDTextBox" runat="server" Text='<%# Bind("MOVIE_MOVIEID") %>' /></td></tr>
                        ...
                        <ItemTemplate>
                            <div class="form-title">Selected Show</div>
                            <table>
                                <tr><td class="field-label">Show ID:</td><td><asp:Label ID="SHOWIDLabel" runat="server" Text='<%# Eval("SHOWID") %>' /></td></tr>
                                <tr><td class="field-label">Show Date:</td><td><asp:Label ID="SHOWDATELabel" runat="server" Text='<%# Eval("SHOWDATE") %>' /></td></tr>
                                <tr><td class="field-label">Show Time:</td><td><asp:Label ID="SHOWTIMELabel" runat="server" Text='<%# Eval("SHOWTIME") %>' /></td></tr>
                                <tr><td class="field-label">Hall ID:</td><td><asp:Label ID="HALL_HALLIDLabel" runat="server" Text='<%# Eval("HALL_HALLID") %>' /></td></tr>
                                <tr><td class="field-label">Movie ID:</td><td><asp:Label ID="MOVIE_MOVIEIDLabel" runat="server" Text='<%# Eval("MOVIE_MOVIEID") %>' /></td></tr>
                                <tr><td class="field-label">Base Price:</td><td><asp:Label ID="BASETICKETPRICELabel" runat="server" Text='<%# Eval("BASETICKETPRICE") %>' /></td></tr>
                            </table>
                            <div style="margin-top:16px;">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>"
                SelectCommand="SELECT * FROM &quot;SHOW&quot; ORDER BY &quot;SHOWID&quot; ASC"
                DeleteCommand="DELETE FROM &quot;SHOW&quot; WHERE &quot;SHOWID&quot; = :SHOWID"
                InsertCommand="INSERT INTO &quot;SHOW&quot; (&quot;SHOWID&quot;, &quot;SHOWDATE&quot;, &quot;SHOWTIME&quot;, &quot;HALL_HALLID&quot;, &quot;MOVIE_MOVIEID&quot;, &quot;BASETICKETPRICE&quot;) VALUES (:SHOWID, :SHOWDATE, :SHOWTIME, :HALL_HALLID, :MOVIE_MOVIEID, :BASETICKETPRICE)"
                UpdateCommand="UPDATE &quot;SHOW&quot; SET &quot;SHOWDATE&quot; = :SHOWDATE, &quot;SHOWTIME&quot; = :SHOWTIME, &quot;HALL_HALLID&quot; = :HALL_HALLID, &quot;MOVIE_MOVIEID&quot; = :MOVIE_MOVIEID, &quot;BASETICKETPRICE&quot; = :BASETICKETPRICE WHERE &quot;SHOWID&quot; = :SHOWID">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="MOVIE_MOVIEID" Type="Decimal" />

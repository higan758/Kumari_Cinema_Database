<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hall.aspx.cs" Inherits="WebForm.SimpleWebform.Hall" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="content-row">
                <div class="card">
                    <div class="page-title">Hall Management</div>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="HALLID" DataSourceID="SqlDataSource1" GridLines="None" CssClass="styled-grid">
                        <Columns>
                            ...
                            <asp:BoundField DataField="CINEMA_CINEMAID" HeaderText="Cinema ID" SortExpression="CINEMA_CINEMAID" />
                ...
                <div class="card-side">
                    <asp:FormView ID="FormView1" runat="server" DataKeyNames="HALLID" DataSourceID="SqlDataSource1" DefaultMode="ReadOnly" RenderOuterTable="false">
                        <EditItemTemplate>
                            <div class="form-title">Edit Hall</div>
                            <table>
                                <tr><td class="field-label">Hall ID:</td><td><asp:Label ID="HALLIDLabel1" runat="server" Text='<%# Eval("HALLID") %>' /></td></tr>
                                <tr><td class="field-label">Capacity:</td><td><asp:TextBox ID="HALLCAPACITYTextBox" runat="server" Text='<%# Bind("HALLCAPACITY") %>' /></td></tr>
                                <tr><td class="field-label">Cinema ID:</td><td><asp:TextBox ID="CINEMA_CINEMAIDTextBox" runat="server" Text='<%# Bind("CINEMA_CINEMAID") %>' /></td></tr>
                                <tr><td class="field-label">Hall Name:</td><td><asp:TextBox ID="HALL_NAMETextBox" runat="server" Text='<%# Bind("HALL_NAME") %>' /></td></tr>
                            </table>
                        ...
                        <InsertItemTemplate>
                            <div class="form-title">Add New Hall</div>
                            <table>
                                <tr><td class="field-label">Hall ID:</td><td><asp:TextBox ID="HALLIDTextBox" runat="server" Text='<%# Bind("HALLID") %>' /></td></tr>
                                <tr><td class="field-label">Capacity:</td><td><asp:TextBox ID="HALLCAPACITYTextBox" runat="server" Text='<%# Bind("HALLCAPACITY") %>' /></td></tr>
                                <tr><td class="field-label">Cinema ID:</td><td><asp:TextBox ID="CINEMA_CINEMAIDTextBox" runat="server" Text='<%# Bind("CINEMA_CINEMAID") %>' /></td></tr>
                                <tr><td class="field-label">Hall Name:</td><td><asp:TextBox ID="HALL_NAMETextBox" runat="server" Text='<%# Bind("HALL_NAME") %>' /></td></tr>
                            </table>
                        ...
                        <ItemTemplate>
                            <div class="form-title">Selected Hall</div>
                            <table>
                                <tr><td class="field-label">Hall ID:</td><td><asp:Label ID="HALLIDLabel" runat="server" Text='<%# Eval("HALLID") %>' /></td></tr>
                                <tr><td class="field-label">Capacity:</td><td><asp:Label ID="HALLCAPACITYLabel" runat="server" Text='<%# Eval("HALLCAPACITY") %>' /></td></tr>
                                <tr><td class="field-label">Cinema ID:</td><td><asp:Label ID="CINEMA_CINEMAIDLabel" runat="server" Text='<%# Eval("CINEMA_CINEMAID") %>' /></td></tr>
                                <tr><td class="field-label">Hall Name:</td><td><asp:Label ID="HALL_NAMELabel" runat="server" Text='<%# Eval("HALL_NAME") %>' /></td></tr>
                            </table>
                            <div style="margin-top:16px;">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>"
                SelectCommand="SELECT * FROM &quot;HALL&quot; ORDER BY &quot;HALLID&quot; ASC"
                DeleteCommand="DELETE FROM &quot;HALL&quot; WHERE &quot;HALLID&quot; = :HALLID"
                InsertCommand="INSERT INTO &quot;HALL&quot; (&quot;HALLID&quot;, &quot;HALLCAPACITY&quot;, &quot;CINEMA_CINEMAID&quot;, &quot;HALL_NAME&quot;) VALUES (:HALLID, :HALLCAPACITY, :CINEMA_CINEMAID, :HALL_NAME)"
                UpdateCommand="UPDATE &quot;HALL&quot; SET &quot;HALLCAPACITY&quot; = :HALLCAPACITY, &quot;CINEMA_CINEMAID&quot; = :CINEMA_CINEMAID, &quot;HALL_NAME&quot; = :HALL_NAME WHERE &quot;HALLID&quot; = :HALLID">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="CINEMA_CINEMAID" Type="Decimal" />
